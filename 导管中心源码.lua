...
local Window = OrionLib:MakeWindow({Name = "BKL脚本", HidePremium = false, SaveConfig = true,IntroText = "BKL脚本", ConfigFolder = "BKL脚本"})
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "bing BKL脚本"; Text ="缝合脚本"; Duration = 4; })
